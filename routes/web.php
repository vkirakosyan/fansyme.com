...
// test profile2
Route::get('profile2/verification', 'Profile2Controller@verifyProfile')->name('profile2.verifyProfile');
Route::post('profile2/process-verification', 'Profile2Controller@processVerification')->name('processVerification2');
...
Route::get('messages/{user}', 'MessagesController@conversation')->name('conversation');
