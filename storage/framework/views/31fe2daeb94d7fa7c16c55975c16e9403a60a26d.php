...
} elseif ($_instance->childHasBeenRendered('5SkdAtt')) {
    $componentId = $_instance->getRenderedChildComponentId('5SkdAtt');
    $componentTag = $_instance->getRenderedChildComponentTagName('5SkdAtt');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5SkdAtt');
} else {
    $response = \Livewire\Livewire::mount('message');
    $dom = $response->dom;
    $_instance->logRenderedChild('5SkdAtt', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fansyme/domains/fansyme.com/private_html/resources/views/messages/inbox.blade.php ENDPATH**/ ?>