...
} elseif ($_instance->childHasBeenRendered('hmU3Qrj')) {
    $componentId = $_instance->getRenderedChildComponentId('hmU3Qrj');
    $componentTag = $_instance->getRenderedChildComponentTagName('hmU3Qrj');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hmU3Qrj');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('hmU3Qrj', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('ks7Norf')) {
    $componentId = $_instance->getRenderedChildComponentId('ks7Norf');
    $componentTag = $_instance->getRenderedChildComponentTagName('ks7Norf');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ks7Norf');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('ks7Norf', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
<?php /**PATH /home/fansyme/domains/fansyme.com/private_html/resources/views/partials/topnavi.blade.php ENDPATH**/ ?>