...
} elseif ($_instance->childHasBeenRendered('VPLhCjz')) {
    $componentId = $_instance->getRenderedChildComponentId('VPLhCjz');
    $componentTag = $_instance->getRenderedChildComponentTagName('VPLhCjz');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VPLhCjz');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('VPLhCjz', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
						</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fansyme/domains/fansyme.com/private_html/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>